...
public class SLL<E> {
    ...
    public void swapNodes(SLLNode<E> n1, SLLNode<E> n2){
        SLLNode<E> prevNode1 = null, prevNode2 = null, node1 = first, node2 = first;
        ...
        //Search for node1
        while(node1 != null && node1 != n1){
            prevNode1 = node1;
            node1 = node1.succ;
        }

        //Search for node2
        while(node2 != null && node2 != n2){
            prevNode2 = node2;
            node2 = node2.succ;
        }
